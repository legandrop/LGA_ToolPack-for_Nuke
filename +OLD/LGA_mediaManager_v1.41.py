...
class FileScanner(QWidget):
    ...
    def delete_selected(self):
        ...
        if multiple_delete:
            ...
            reply = msgBox.exec_()
            if reply != QMessageBox.Yes:
                return  # Si el usuario cancela, no proceder con el borrad
    ...
    def calculate_total_files_to_delete(self, files_to_delete):
        ...
        print("Contenido de files_to_delete:")
        for file_path, row in files_to_delete:
        ...
        for file_path, row in files_to_delete:
            ...
            print(f"Fila {row}:")
            print(f"  - File Path: {file_path_text}")
            print(f"  - Sequence Status: {sequence_status}")
            ...
            if frame_range_match:
                ...
                print(f"  - Secuencia detectada: {end_frame - start_frame + 1} archivos")
            else:
                # Si no es una secuencia, contar como un solo archivo
                total_files += 1
                print("  - Archivo unico detectado")

        print(f"Total de archivos a borrar: {total_files}")
        return total_files
