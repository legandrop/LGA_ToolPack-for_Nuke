...
from PySide2.QtWidgets import QApplication, QWidget, QVBoxLayout, QTableWidget, QTableWidgetItem, QHeaderView, QPushButton, QHBoxLayout, QLabel
...
class SelectedNodeInfo(QWidget):
    ...
    def initUI(self):
        ...
        # Posicionar el boton por encima de la tabla
        close_button.move(0, 40)  # Mueve la X 40 pixeles hacia abajo, ajustalo segun necesidad

        # Anadir el title_bar al layout
        layout.addWidget(title_bar)        

        # Crear la tabla con 1 columna y tantas filas como espacios de color haya
