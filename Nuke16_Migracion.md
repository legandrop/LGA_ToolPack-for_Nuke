...
- [ ] `LGA_mediaPathReplacer.py` — PySide2 directo.
- [ ] `LGA_Write_PathToText.py` — PySide2 directo.
- [ ] `LGA_Write_Presets_Check.py` — PySide2 (`QTimer`).
- [ ] `LGA_RnW_ColorSpace_Favs.py` — PySide2 directo.
- [ ] `LGA_disable_A_B.py` — PySide2 directo.
